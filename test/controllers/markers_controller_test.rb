...
class MarkersControllerTest < ActionController::TestCase
  ...
  test "should create marker" do
    assert_difference('Marker.count') do
      post :create, marker: { description: @marker.description, locationx: @marker.locationx, locationy: @marker.locationy, name: @marker.name, ownerid: @marker.ownerid }
    end
  ...
  test "should update marker" do
    patch :update, id: @marker, marker: { description: @marker.description, locationx: @marker.locationx, locationy: @marker.locationy, name: @marker.name, ownerid: @marker.ownerid }
    assert_redirected_to marker_path(assigns(:marker))
  end
